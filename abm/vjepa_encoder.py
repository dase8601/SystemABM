...
Note: DINOv3 weights are gated at both HuggingFace and fbaipublicfiles.com
(403 Forbidden). DINOv2 weights are freely public. DINOv2 already produces
discriminative features: cos_sim(black,white) ≈ 0.62 vs V-JEPA's 0.997.
...
class VJEPAEncoder:
    ...
    def __init__(self, device: str = "cuda", img_size: int = 224):
        ...
        with torch.no_grad():
            ...
            if bw_sim > 0.70:
                print("  WARNING: features may not be discriminative!")
            else:
